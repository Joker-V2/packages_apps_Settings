...
public class StatusBarSettings extends SettingsPreferenceFragment
    ...
    public void onResume() {
        ...
        if (DateFormat.is24HourFormat(getActivity())) {
            ...
            mStatusBarAmPm.setSummaryProvider(preference ->
                    preference.getContext().getString(R.string.status_bar_am_pm_info));
        }

        final boolean disallowCenteredClock =
                DeviceUtils.hasCenteredCutout(getActivity())
    ...
    private int getNetworkTrafficStatus() {
        int mode = LineageSettings.Secure.getInt(
                getActivity().getContentResolver(),
                LineageSettings.Secure.NETWORK_TRAFFIC_MODE, 0);

        int position = LineageSettings.Secure.getInt(
                getActivity().getContentResolver(),
                LineageSettings.Secure.NETWORK_TRAFFIC_POSITION, 1); // center
